...
- Content pipeline, pilot, and bank scale. The generate, solve, verify, audit
  pipeline (`specs/content-pipeline.md`) ran a pilot to completion, then three
  ...
  the living ledger is `packs/ca-foundation-qa/audit/STATUS.md`, regenerated by
  `tools/content_status.py`.
